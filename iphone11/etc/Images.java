...
public class Images {
    ...
    private static final String BLUETOOTH_OFF_PNG = PATH + "setting/bluetoothOff.png";
    private static final String DATA_ON_PNG = PATH + "setting/dataOn.png";
    ...
    public static final ImageIcon BLUETOOTH_OFF = new ImageIcon(BLUETOOTH_OFF_PNG);
    public static final ImageIcon DATA_ON = new ImageIcon(DATA_ON_PNG);
